...
<div class="particulars-cont-zhb">
  ...
  <div class="particulars-head-zhb">
    <div class="particularsHead-zhb">
      <particularsHeads v-on:listenToc="showShare">
    ...
    <div class="part-spec-zhb">
      ...
      <!--选择规格-->
      <spaecifications v-if="spaecifStatr" v-on:selectgs="showSeleGs" v-bind:class-goods="classGoods" v-bind:cur-piar="cuspar">
  ...
  <!--商品详情-->
  <commoditys v-bind:commod-imgs="infoImgs"></commoditys>
  <!--end-->
  <!--猜你喜欢-->
  <div class="like-zhb">
  ...
  <!--分享-->
  <shares v-show="showStat" v-on:colseChek="showShareto"></shares>
