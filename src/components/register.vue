    ...
    <div class="container">
      <form action="">
        ...
        <div class="auth-code">
          ...
          <span @click="handleSendAuthCode($event)" class="auth-btn">GET OTP</span>
        </div>
        <div class="password">
...
<style lang="scss" scoped>
  ...
  .visible {
    background-image: url("../assets/icon/see@2x.png");
  }
  .hide {
    background-image: url("../assets/icon/hide@2x.png");
  }
  .register-bar {
    border: none;
    outline: none;
